...
import { Loader2, School, User, Lock, MapPin, ArrowLeft, Send, CheckCircle2, Shield } from "lucide-react";
...
export function RegisterSchoolContent({ siteSettings }: { siteSettings?: Record<string, string> }) {
                ...
                <div className="relative z-10 max-w-lg space-y-12">
                    <div className="space-y-6">
                        ...
                        <h1 className="text-5xl font-bold font-outfit text-white leading-tight">
                            Partner with <br />
                            <span className="text-indigo-400">{siteTitle}</span>
                        </h1>
                ...
                <div className="w-full max-w-md">
                    <div className="mb-10 text-center lg:text-left">
                        <Link href="/" className="inline-block mb-8">
                            <span className="text-3xl font-bold font-outfit text-gradient">{siteTitle}</span>
                        </Link>

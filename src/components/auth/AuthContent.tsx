...
export function AuthContent({ siteSettings }: { siteSettings?: Record<string, string> }) {
                    ...
                    <div className="mb-10 flex flex-col items-center lg:items-start">
                        <Link href="/" className="mb-8 group">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-3xl font-black font-outfit tracking-tighter text-slate-900">{siteTitle}</span>
                            </div>
                        </Link>
